...
fetch_price_table <- function() {
  ...
  # stringi::stri_escape_unicode(c("通用型实例", "计算优化型实例", "GPU 实例", "内存优化型实例", "存储优化型实例", "机器学习 ASIC 实例"))
  # stringi::stri_escape_unicode(c("实例", "实例类型", "内存", "宁夏", "北京", "不适用"))
  tb_nx <- tables[[1]]
  tb_nx <- tb_nx[-grep("^$", tb_nx[, stri_unescape_unicode('\\u5b9e\\u4f8b\\u7c7b\\u578b')]), ]

  x <- c(grep(stri_unescape_unicode('\\u5b9e\\u4f8b'), tb_nx[, stri_unescape_unicode('\\u5b9e\\u4f8b\\u7c7b\\u578b')]), nrow(tb_nx)+1)
  tb_nx$type <- stri_unescape_unicode(rep(c("\\u901a\\u7528\\u578b\\u5b9e\\u4f8b", "\\u8ba1\\u7b97\\u4f18\\u5316\\u578b\\u5b9e\\u4f8b", "GPU \\u5b9e\\u4f8b", "\\u5185\\u5b58\\u4f18\\u5316\\u578b\\u5b9e\\u4f8b", "\\u5b58\\u50a8\\u4f18\\u5316\\u578b\\u5b9e\\u4f8b", "\\u673a\\u5668\\u5b66\\u4e60 ASIC \\u5b9e\\u4f8b"), diff(x)))
  ...
  # tb_bj$type <- stri_unescape_unicode(rep(c("\\u901a\\u7528\\u578b\\u5b9e\\u4f8b", "\\u8ba1\\u7b97\\u4f18\\u5316\\u578b\\u5b9e\\u4f8b", "GPU \\u5b9e\\u4f8b", "\\u5185\\u5b58\\u4f18\\u5316\\u578b\\u5b9e\\u4f8b", "\\u5b58\\u50a8\\u4f18\\u5316\\u578b\\u5b9e\\u4f8b", "\\u673a\\u5668\\u5b66\\u4e60 ASIC \\u5b9e\\u4f8b"), diff(x)))
